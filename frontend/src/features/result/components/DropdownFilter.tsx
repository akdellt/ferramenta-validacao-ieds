  ...
  return (
    <div className="relative w-full min-w-60" ref={dropdownRef}>
      <button
        ...
        className={`flex h-12 w-full cursor-pointer items-center justify-between rounded-lg border-2 bg-white px-4 shadow-sm transition-all duration-200 ${
          isOpen
            ? "border-eq-primary ring-2 ring-blue-50"
            : "border-eq-border hover:border-eq-primary"
        }`}
      >
        <span
